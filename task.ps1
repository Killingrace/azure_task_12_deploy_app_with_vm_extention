...
$extentionParams = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/killingrace/azure_task_12_deploy_app_with_vm_extention/main/install-app.sh'); commandToExecute = './install-app.sh'}
}
Set-AzVMExtension @extentionParams